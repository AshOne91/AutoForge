...
- [ ] Kubernetes-native Control Plane deployment implementation after a migration
  executor and durable version-tracking contract exist: use the selected standard
