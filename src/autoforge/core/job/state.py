...
from autoforge.core.git import GitCommitResult, GitPullRequestResult, GitPushResult
...
_ALLOWED_TRANSITIONS: dict[GenerationJobStatus, frozenset[GenerationJobStatus]] = {
    ...
    GenerationJobStatus.OPENING_PULL_REQUEST: frozenset(
